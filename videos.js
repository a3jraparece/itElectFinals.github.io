document.addEventListener('DOMContentLoaded', (event) => {
    ...
    const videoImage = localStorage.getItem('selectedVideoImage');
    const videoTitle = localStorage.getItem('selectedLinkTitle');

    document.getElementById('mainVideo').src = selectedVideo;
    document.getElementById('imgSource').src = videoImage;
    document.getElementById('titleVid').innerHTML = videoTitle;
